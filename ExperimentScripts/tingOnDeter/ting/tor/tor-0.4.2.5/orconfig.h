...
/* # for 0.4.2.5 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2019-12-05"

/* tor's build directory */
#define BUILDDIR "/users/magesap/TorLatencyNormalizationFiles/ExperimentScripts/tingOnDeter/ting/tor/tor-0.4.2.5"
...
#define PACKAGE_STRING "tor 0.4.2.5"
...
#define PACKAGE_VERSION "0.4.2.5"
...
#define SRCDIR "/users/magesap/TorLatencyNormalizationFiles/ExperimentScripts/tingOnDeter/ting/tor/tor-0.4.2.5"
