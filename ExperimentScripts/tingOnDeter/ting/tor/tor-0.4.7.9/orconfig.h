...
/* # for 0.4.7.9 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2022-08-11"

/* tor's build directory */
#define BUILDDIR "/users/magesap/TorLatencyNormalizationFiles/ExperimentScripts/tingOnDeter/ting/tor/tor-0.4.7.9"
...
#define PACKAGE_STRING "tor 0.4.7.9"
...
#define PACKAGE_VERSION "0.4.7.9"
...
#define SRCDIR "/users/magesap/TorLatencyNormalizationFiles/ExperimentScripts/tingOnDeter/ting/tor/tor-0.4.7.9"
