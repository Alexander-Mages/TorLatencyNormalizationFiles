...
/* # for 0.4.5.10 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2021-08-16"

/* tor's build directory */
#define BUILDDIR "/users/magesap/TorLatencyNormalizationFiles/ExperimentScripts/tingOnDeter/ting/tor/tor-0.4.5.10"
...
#define PACKAGE_STRING "tor 0.4.5.10"
...
#define PACKAGE_VERSION "0.4.5.10"
...
#define SRCDIR "/users/magesap/TorLatencyNormalizationFiles/ExperimentScripts/tingOnDeter/ting/tor/tor-0.4.5.10"
